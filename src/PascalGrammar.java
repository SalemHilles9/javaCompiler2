...
class PascalGrammar {
    ...
    public void error(String expectedToken, Token.TokenType expectedType) {
        error += switch (expectedType) {
            case KEYWORD ->
                    String.format("It is expected to have a keyword '%s' in line %d%n", expectedToken, currentToken.getLine());
            case IDENTIFIER ->
                    String.format("It is expected to have an identifier '%s' in line %d%n", expectedToken, currentToken.getLine());
            case NUMERIC_CONSTANT ->
                    String.format("It is expected to have a numeric constant '%s' in line %d%n", expectedToken, currentToken.getLine());
        };
    }
